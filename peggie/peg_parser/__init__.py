r"""
The :py:mod:`peggie.peg_parser` module implements a simple parsing
library which may be used to parse text-based inputs given a suitable grammar.
...
Next, the grammar must be compiled using :py:func:`.compile_grammar`::
    ...
    >>> from peggie.peg_parser import compile_grammar
...
strings according to the grammar. For example::
    ...
    >>> from peggie.peg_parser import Parser
...
Python list from the parse tree like so::
    ...
    >>> from peggie.peg_parser import ParseTreeTransformer
...
.. include:: ../../peggie/peg_parser/meta_grammar.peg
    :literal:
...
be produced::
    ...
    >>> from peggie.peg_parser import ParseError
...
For example::
    ...
    >>> from peggie.peg_parser import RuleExpr, RegexExpr
